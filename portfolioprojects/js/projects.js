...
const projects = [
  ...
  },
  {
    ...
    fullDescription: 'AK Tours & Travels was developed as a freelance business website to provide an online presence for a travel agency. The platform includes sections for company information, tour packages, offers, updates, inquiries, and customer feedback, with admin-friendly content management.',
    highlights: ['Responsive business website', 'Trip scheduling and inquiry system', 'Customer feedback collection', 'Reusable React components and scalable architecture'],
